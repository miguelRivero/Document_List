...
describe('AddDocumentModal', () => {
  ...
  let modalInstance: AddDocumentModal;
  ...
  it('closes the modal when close button is clicked', () => {
    modalInstance.open();
    const closeBtn = document.body.querySelector('.modal-close-btn') as HTMLButtonElement | null;
  ...
  it('closes the modal when overlay is clicked', () => {
    modalInstance.open();
    const overlay = document.body.querySelector('.modal-overlay') as HTMLDivElement | null;
  ...
  it('wires onSubmit and closes modal when called', () => {
    ...
    (modalInstance as any).onSubmit(testDoc);
